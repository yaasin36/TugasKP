    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="float-left">
                <h4 class="page-title">Laporan Simpanan </h4>
                <small class="text-danger">Periode : {{ periode()->name }}</small>
            </div>
            <div class="float-right">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Laporan</a></li>
                <li class="breadcrumb-item active"><a href="{{route('laporan.simpanan-all')}}">Laporan Simpanan</a></li>
                </ol>
        ...
        <div class="card-box">
            <form id="periode" action="{{ route('laporan.simpanan-all') }}" method="GET">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker" name="start_date" autocomplete="off" value="{{ old('start_date', request('start_date')) }}">
                </div>
                <div class="form-group">
                    <label for="">Tanggal Akhir</label>
                    <input type="text" class="form-control datepicker" name="end_date" autocomplete="off" value="{{ old('end_date', request('end_date')) }}">
                </div>
