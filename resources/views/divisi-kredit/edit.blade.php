            ...
            <div class="page-title-box">
                ...
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('divisi-kredit.index') }}">Divisi Kredit</a>
                        </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                ...
                {!! Form::model($transaksiHarian, [
                    'route' => ['divisi-kredit.update', $transaksiHarian->transaksi_harian_id],
                    'method' => 'put',
    ...
    <script>
        $(function() {
            ...
            $('select[name=divisi_id]').on('change', function() {
                ...
                var url = "/check-biaya-kredit" + "/" + divisiId;
                $.ajax({
                    url: url,
                    type: 'GET',
